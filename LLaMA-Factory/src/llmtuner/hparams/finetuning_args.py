...
class EMAArgument:
    r"""
    Arguments pertaining to the online merging optimizer.
    """

    use_ema: bool = field(
        default=False,
        metadata={"help": "Whether or not to use the EMA AdamW optimizer."},
    )
    ema_rate: float = field(
        default=1e-3,
        metadata={"help": "EMA rate for history."},
    )


@dataclass
class OnlineMergingArgument:
    r"""
    Arguments pertaining to the online merging optimizer.
    """

    use_online_merging: bool = field(
        default=False,
        metadata={"help": "Whether or not to use the Online Merging optimizer."},
    )
    use_om_full: bool = field(
        default=False,
        metadata={"help": "Whether or not to use the Online Merging optimizer."},
    )
    om_mode: Literal["ondare", "onties"] = field(
        default="dare",
        metadata={"help": "Whether to use layer-wise or ratio-wise BAdam optimizer."},
    )
    ...
    base_model_adapters: str = field(
        default=None,
        metadata={"help": ""}
    )
    base_model_quantization_bit: int = field(
        default=None,
        metadata={"help": ""}
    )
...
@dataclass
class FinetuningArguments(FreezeArguments, LoraArguments, RLHFArguments, GaloreArguments, BAdamArgument, OnlineMergingArgument, EMAArgument):
    r"""
